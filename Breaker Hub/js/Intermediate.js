...
document.getElementById("REM").innerHTML="25"
...
function createGrid()
{
  ...
  {
    let gridElement = document.createElement("div")
    gridElement.setAttribute("class" , "block2")
    grid.appendChild(gridElement)
  }
...
const theBricks=[tBrick, lBrick, oBrick, IBrick, zBrick]
...
{
  clearInterval(timerId)
  document.removeEventListener('e', control)
  clearInterval(interval)
...
//}
  ...
  function gameTime()
 {
    time=document.getElementById("REM").innerHTML="25"
